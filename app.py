...
# ============================================
    ...
    with st.form('hours_form'):
        for emp in EMPLOYEES:
            ...
            st.markdown('<div class="employee-row">', unsafe_allow_html=True)
    ...
    if df['Часы'].sum() == 0:
        ...
        if len(df) >= 3:
            ...
            with col1:
                ...
                <p><b>""" + f'{df.iloc[1]["Часы"]:.1f}' + """ ч</b></p>
                <p>Переработка: """ + f'{df.iloc[1]["Переработка"]:.1f}' + """ ч</p>
                </div>
                """, unsafe_allow_html=True)
            with col2:
                st.markdown("""
                ...
                <p style="font-size:24px;"><b>""" + f'{df.iloc[0]["Часы"]:.1f}' + """ ч</b></p>
                <p>Переработка: """ + f'{df.iloc[0]["Переработка"]:.1f}' + """ ч</p>
            ...
            with col3:
                ...
                <p><b>""" + f'{df.iloc[2]["Часы"]:.1f}' + """ ч</b></p>
                <p>Переработка: """ + f'{df.iloc[2]["Переработка"]:.1f}' + """ ч</p>
                </div>
                """, unsafe_allow_html=True)
        ...
        with col1:
            ...
            <p>""" + f'{df.iloc[0]["Часы"]:.1f}' + """ часов | """ + f'{df.iloc[0]["Переработка"]:.1f}' + """ ч переработки</p>
            </div>
            """, unsafe_allow_html=True)
        with col2:
            st.markdown("""
            ...
            <p>""" + f'{df.iloc[-1]["Часы"]:.1f}' + """ часов | эффективность """ + f'{df.iloc[-1]["Эффективность %"]:.0f}' + """%</p>
            </div>
            """, unsafe_allow_html=True)
